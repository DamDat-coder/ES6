!(function (e, t) {
  ...
  var f = (function (n) {
    ...
    try {
      _.apply((t = I.call(b.childNodes)), b.childNodes),
              ...
              return (
                ...
                ue(function (e, t, n, i) {
                  var r,
                    ...
                    d = g ? (m || (e ? f : u || v) ? [] : t) : h;
                  if ((g && g(h, d, n, i), v))
                    for (r = xe(d, l), v(r, [], n, i), o = r.length; o--; )
                      (s = r[o]) && (d[l[o]] = !(h[l[o]] = s));
                  if (e) {
                    if (m || f) {
                      if (m) {
                  ...
                  } else (d = xe(d === t ? d.splice(u, d.length) : d)), m ? m(null, t, d, i) : _.apply(t, d);
                })
              );
            })(
              1 < a && be(c),
            ...
            (s = L(
              ...
              (i = function (e, t, n, i, r) {
                ...
                for (
                  ...
                  if (b && o) {
                    for (
                      s = 0, t || o.ownerDocument == E || (C(o), (n = !S));
                      (a = v[s++]);
                ...
                if (((l += u), y && u !== l)) {
                  for (s = 0; (a = m[s++]); ) a(c, h, t, n);
                  if (e) {
                    if (0 < l) for (; u--; ) c[u] || h[u] || (h[u] = q.call(i));
                    h = xe(h);
                  }
                  _.apply(i, h),
                    r &&
      ...
      function (i, r) {
        k.fn[i] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (q[i] || k.uniqueSort(n), P.test(i) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
        ...
        var o = [
          ...
          s = {
            ...
            then: function (t, n, i) {
                  ...
                  function e() {
                    ...
                    if (!(r < l)) {
                      ...
                      (t =
                        ...
                        b(t)
                          ? a
                            ? t.call(e, u(l, o, I, a), u(l, o, M, a))
                            : (l++,
                              t.call(
                                e,
                                u(l, o, I, a),
                                u(l, o, M, a),
                                u(l, o, I, o.notifyWith)
                              ))
                          : (s !== I && ((n = void 0), (i = [e])),
                            (a || o.resolveWith)(n, i));
                    }
              ...
              return k
                .Deferred(function (e) {
                  o[0][3].add(u(0, e, b(i) ? i : I, e.notifyWith)),
                    o[1][3].add(u(0, e, b(t) ? t : I)),
  ...
  function be(e, t, n, i, r) {
    ...
    for (h.textContent = "", f = 0; (o = d[f++]); )
      if (i && -1 < k.inArray(o, i)) r && r.push(o);
        ...
        ((u = re(o)), (s = ve(h.appendChild(o), "script")), u && me(s), n)
      )
  ...
  function ke(e, r, o) {
    o
      ...
      : void 0 === Q.get(e, r) && k.event.add(e, r, we);
  }
  (k.event = {
    global: {},
      ...
      if (v && (l = v.events)) {
        for (u = (t = (t || "").match(_) || [""]).length; u--; )
          if (
            ...
            s &&
              !d.length &&
              ((h.teardown && !1 !== h.teardown.call(e, p, v.handle)) ||
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && T(t, "input") && ke(t, "click", we),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && T(t, "input") && ke(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function qe(n, i, r, o) {
    ...
    var e,
      ...
      f = i[0],
      p = b(f);
    if (p || (1 < h && "string" == typeof f && !y.checkClone && Te.test(f)))
      return n.each(function (e) {
        var t = n.eq(e);
        p && (i[0] = f.call(this, e, t.html())), qe(t, i, r, o);
      });
    if (
      h &&
      ...
      for (a = (s = k.map(ve(e, "script"), je)).length; c < h; c++)
        (l = e),
          c !== d &&
            ((l = k.clone(l, !0, !0)), a && k.merge(s, ve(l, "script"))),
          r.call(n[c], l, c);
      if (a)
        for (u = s[s.length - 1].ownerDocument, k.map(s, Ne), c = 0; c < a; c++)
          (l = s[c]),
            fe.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : x(l.textContent.replace(Ae, ""), l, u));
    }
    return n;
  }
  function ze(e, t, n) {
    for (var i, r = t ? k.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
      n || 1 !== i.nodeType || k.cleanData(ve(i)),
        i.parentNode &&
  ...
  k.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (o = o || ve(e), s = s || ve(c), i = 0, r = o.length; i < r; i++)
            Pe(o[i], s[i]);
        else Pe(e, c);
      return (
        0 < (s = ve(c, "script")).length && me(s, !h && ve(e, "script")), c
      );
    },
  ...
  k.extend({
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var r,
          ...
          u = e.style;
        if (
          (l || (t = et(a)), (s = k.cssHooks[t] || k.cssHooks[a]), void 0 === n)
        )
    ...
    k.each(["height", "width"], function (e, l) {
      k.cssHooks[l] = {
        get: function (e, t, n) {
          if (t)
            return !tt.test(k.css(e, "display")) ||
    ...
    k.each({ margin: "", padding: "", border: "Width" }, function (r, o) {
      (k.cssHooks[r + o] = {
        ...
        "margin" !== r && (k.cssHooks[r + o].set = ot);
    }),
    k.fn.extend({
      css: function (e, t) {
        return R(
      ...
      _default: {
        ...
        set: function (e) {
          k.fx.step[e.prop]
            ? k.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!k.cssHooks[e.prop] && null == e.elem.style[et(e.prop)])
            ? (e.elem[e.prop] = e.now)
  ...
  function gt() {
    ct &&
      (!1 === S.hidden && E.requestAnimationFrame
        ? E.requestAnimationFrame(gt)
        : E.setTimeout(gt, k.fx.interval),
      k.fx.tick());
  }
  function vt() {
    return (
  ...
  k.fn.extend({
    ...
    k.fn.extend({
      addClass: function (t) {
        ...
        if (b(t))
          return this.each(function (e) {
            k(this).addClass(t.call(this, e, kt(this)));
          });
        if ((e = Dt(t)).length)
          for (; (n = this[l++]); )
      ...
      removeClass: function (t) {
        ...
        if (b(t))
          return this.each(function (e) {
            k(this).removeClass(t.call(this, e, kt(this)));
          });
      ...
      toggleClass: function (r, t) {
        ...
        return "boolean" == typeof t && s
          ...
          ? this.each(function (e) {
              k(this).toggleClass(r.call(this, e, kt(this), t), t);
            })
          : this.each(function () {
              var e, t, n, i;
              if (s)
                for (t = 0, n = k(this), i = Dt(r); (e = i[t++]); )
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== r && "boolean" != o) ||
                  ((e = kt(this)) && Q.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  k.extend(k.event, {
    trigger: function (e, t, n, i) {
      ...
      if (
        ...
        if (!i && !u.noBubble && !g(n)) {
          for (
            s = u.delegateType || d, Lt.test(s + d) || (p = p.parentNode);
            p;
            p = p.parentNode
          )
            h.push(p), (o = p);
          o === (n.ownerDocument || S) &&
            h.push(o.defaultView || o.parentWindow || E);
        }
        ...
        return (
          ...
          i ||
            ...
            (a &&
              ...
              ((o = n[a]) && (n[a] = null),
              (k.event.triggered = d),
              e.isPropagationStopped() && c.addEventListener(d, At),
              n[d](),
              e.isPropagationStopped() && c.removeEventListener(d, At),
    ...
    k.extend({
      ...
      ajax: function (e, t) {
        ...
        v.hasContent
          ...
          : ((o = v.url.slice(h.length)),
            v.data &&
              (v.processData || "string" == typeof v.data) &&
              ((h += (Pt.test(h) ? "&" : "?") + v.data), delete v.data),
            !1 === v.cache &&
              ((h = h.replace(Ft, "$1")),
              (o = (Pt.test(h) ? "&" : "?") + "_=" + Nt.guid++ + o)),
            (v.url = h + o)),
        v.ifModified &&
          (k.lastModified[h] &&
            C.setRequestHeader("If-Modified-Since", k.lastModified[h]),
          k.etag[h] && C.setRequestHeader("If-None-Match", k.etag[h])),
        ...
        if (
          ...
          if (((C.readyState = 1), g && y.trigger("ajaxSend", [C, v]), p))
            return C;
          v.async &&
            0 < v.timeout &&
        ...
        function u(e, t, n, i) {
          ...
          p ||
            ...
            !r &&
              -1 < k.inArray("script", v.dataTypes) &&
              k.inArray("json", v.dataTypes) < 0 &&
            ...
            r
              ? (v.ifModified &&
                  ((l = C.getResponseHeader("Last-Modified")) &&
                    (k.lastModified[h] = l),
                  (l = C.getResponseHeader("etag")) && (k.etag[h] = l)),
                204 === e || "HEAD" === v.type
                  ? (u = "nocontent")
                  : 304 === e
                  ? (u = "notmodified")
            ...
            (C.status = e),
            (C.statusText = (t || u) + ""),
            r ? b.resolveWith(m, [o, u, C]) : b.rejectWith(m, [C, u, s]),
            C.statusCode(w),
            (w = void 0),
            g && y.trigger(r ? "ajaxSuccess" : "ajaxError", [C, v, r ? o : s]),
            x.fireWith(m, [C, u]),
            g &&
  ...
  k.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = Zt.pop() || k.expando + "_" + Nt.guid++;
      return (this[e] = !0), e;
    },
  }),
    k.ajaxPrefilter("json jsonp", function (e, t, n) {
      ...
      if (s || "jsonp" === e.dataTypes[0])
        return (
          ...
          n.always(function () {
            void 0 === r ? k(E).removeProp(i) : (E[i] = r),
    ...
    k.each(["top", "left"], function (e, n) {
      k.cssHooks[n] = Ve(y.pixelPosition, function (e, t) {
        if (t)
          return (t = Ge(e, n)), Ue.test(t) ? k(e).position()[n] + "px" : t;
      });
    }),
  ...
  return (
    (k.noConflict = function (e) {
      return E.$ === k && (E.$ = rn), e && E.jQuery === k && (E.jQuery = nn), k;
    }),
    void 0 === e && (E.jQuery = E.$ = k),
    k
  );
}),
  (function (t, n) {
    ...
    function D(e) {
      ...
      if (
        (k ||
          ...
          (n = document.body || document.documentElement).appendChild(t),
          (i = E(t)),
          (S = 200 == Math.round(x(i.width))),
          (D.isBoxSizeOuter = S),
          n.removeChild(t)),
        ...
        for (
          var s = (o.isBorderBox = "border-box" == r.boxSizing), a = 0;
          a < C;
          a++
        ) {
          var l = w[a],
        ...
        var h = o.paddingLeft + o.paddingRight,
          ...
          m = s && S,
          y = x(r.width);
        !1 !== y && (o.width = y + (m ? 0 : h + g));
        var b = x(r.height);
        return (
          !1 !== b && (o.height = b + (m ? 0 : d + v)),
          (o.innerWidth = o.width - (h + g)),
          (o.innerHeight = o.height - (d + v)),
          (o.outerWidth = o.width + f),
          (o.outerHeight = o.height + p),
          o
        );
      }
    }
        ...
        c.docReady(function () {
          ...
          i.forEach(function (e) {
            ...
            try {
              ...
              return void (
                h &&
                h.error("Error parsing " + r + " on " + e.className + ": " + n)
              );
            }
            var i = new a(e, t);
            s && s.data(e, l, i);
      ...
      (n.insert = function (e, t) {
        ...
        u &&
          ...
          (s = t == n)
            ...
            : ((a = this.cells[t].element), this.slider.insertBefore(i, a)),
          0 === t
            ? (this.cells = u.concat(this.cells))
            : s
            ? (this.cells = this.cells.concat(u))
            : ((l = this.cells.splice(t, n - t)),
              (this.cells = this.cells.concat(u).concat(l))),
          this._sizeCells(u),
          this.cellChange(t, !0));
      }),
      (n.append = function (e) {
    ...
    return (
      ...
      (e.navCompanionSelect = function (e) {
        var t,
          ...
          a,
          l,
          u = this.navCompanion && this.navCompanion.selectedCells;
        u &&
          ((t = u[0]),
          (i = (n = this.navCompanion.cells.indexOf(t)) + u.length - 1),
          (r = Math.floor(
            ((o = n),
            (s = i),
